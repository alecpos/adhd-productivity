...
class CommitmentBase(BaseModel):
    ...
    priority: CommitmentPriority = Field(
        CommitmentPriority.MEDIUM, description="Priority of the commitment"
    )
...
class CommitmentCreate(CommitmentBase):
    ...
    cross_references: Optional[List[int]] = Field(
        None, description="References to related commitments"
    )
