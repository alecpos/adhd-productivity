...
def get_recurring_dates(
    ...
    dates = list(rrule(freq=freq, interval=interval, dtstart=start_date, until=range_end))
...
def get_next_available_slot(
    start_time: datetime, duration: int, existing_events: List[Dict[str, datetime]]
) -> datetime:
