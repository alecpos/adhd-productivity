...
from app.schemas.analytics_schema import AnalyticsSchema, AnalyticsResponseSchema
from app.services.base_service import BaseService


class AnalyticsService(BaseService[User, AnalyticsResponseSchema, AnalyticsSchema]):
    """Service for handling analytics operations."""

    def __init__(self, db: AsyncSession):
        """Initialize service with database session."""
        super().__init__(db=db, model=User, response_schema=AnalyticsResponseSchema)
