...
class MindfulnessRouter(
    BaseRouter[MindfulnessSessionResponseSchema, MindfulnessService, MindfulnessSessionModel]
):
    ...
    def _register_custom_routes(self):
        ...
        async def get_break_suggestion(
            ...
            try:
                ...
                return APIResponse(
                    data=suggestion, message="Mindfulness suggestion retrieved successfully"
                )
        ...
        @self.router.get(
            "/history", response_model=APIResponse[list[MindfulnessSessionResponseSchema]]
        )
        async def get_session_history(
            ...
            try:
                ...
                return APIResponse(
                    data=[
                        MindfulnessSessionResponseSchema.from_orm(session) for session in sessions
                    ],
