...
def main():
    ...
    # Get base structures
    base_structures = {
        "BaseService": get_base_structure(
            str(workspace_root / "app" / "services" / "base_service.py")
        ),
        ...
        "BaseSchema": get_base_structure(
            str(workspace_root / "app" / "schemas" / "base_schema.py")
        ),
    }
