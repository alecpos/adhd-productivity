# General ML Task Implementation Chain of Reasoning
...
### ML Architecture
- **Model Type:** [e.g., LSTM, Transformer, etc.]
- **Input Features:**
...
| Performance Tests | [Scope] | [Tools] | [Criteria] |
...
### Phase 1: Foundation
- [ ] Set up data pipeline for [data source]
- [ ] Implement data validation for [criteria]
...
- [ ] Implement edge case handling for [scenarios]
